...
public class UsuarioDao {
	...
	// Metos insere banco pegando valores das variaveis da classe usuario
	...
	public UsuarioDao deletar(int idUs) {
		...
		try {
			...
			stmt.setInt(1, idUs);
			JOptionPane.showMessageDialog(null, "Usu�rio " + idUs + " apagado com sucesso!!!");

		} catch (SQLException e) {
			JOptionPane.showMessageDialog(null, "ERRO: Problemas ao apagar usuario!!!");
			e.printStackTrace();
		}
